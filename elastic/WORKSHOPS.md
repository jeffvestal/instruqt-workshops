...
## Workshop 3: Instruqt Workshop Skill Test
...
1. **Workshop Overview** — Intro slides, no interaction
2. **Query Elasticsearch from the Terminal** — curl cluster health, list indices, run search
3. **Explore Agent Builder in Kibana** — Create an AI agent and chat with it

### Notes

Generated by the `hive-instruqt-workshop` skill as a test track. Not a production workshop.
