...
![CleanShot 2025-08-06 at 17.49.02@2x.png](../assets/CleanShot%202025-08-06%20at%2017.49.02%402x.png)
2. Click on the `Try ES|LQ` button near the top of the page
 ![CleanShot 2025-08-06 at 17.33.32@2x.png](../assets/CleanShot%202025-08-06%20at%2017.33.32%402x.png)
...
| LIMIT 10
```
![CleanShot 2025-08-19 at 14.19.27@2x.png](../assets/CleanShot%202025-08-19%20at%2014.19.27%402x.png)
4. Click the play button
![CleanShot 2025-08-06 at 17.50.43@2x.png](../assets/CleanShot%202025-08-06%20at%2017.50.43%402x.png)
...
> ![CleanShot 2025-08-19 at 14.20.14@2x.png](../assets/CleanShot%202025-08-19%20at%2014.20.14%402x.png)
...
This is the most powerful feature for our demo. `LOOKUP JOIN` allows us to enrich our data by combining it with documents from other indices. This is how we'll link our news and reports to asset metadata.
...
## ESQL Query Parameter Syntax
  ...
  * **In the query string:** Use a question mark followed by the parameter name (e.g., `?symbol`, `?time_duration`).
...
![CleanShot 2025-08-19 at 14.34.46@2x.png](../assets/CleanShot%202025-08-19%20at%2014.34.46%402x.png)
...
> ![CleanShot 2025-08-07 at 10.17.53@2x.png](../assets/CleanShot%202025-08-07%20at%2010.17.53%402x.png)
> 2. Toggle Off `Wrap Long Lines`
> ![CleanShot 2025-08-07 at 10.19.48@2x.png](../assets/CleanShot%202025-08-07%20at%2010.19.48%402x.png)
